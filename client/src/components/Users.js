...
export default function Users() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (selectedUser) {
        updateMutation.mutate(selectedUser.id, body);
      } else {
  ...
  const onEdit = (userId) => {
    reset();
    const user = data.find((user) => user.id === userId) || null;
  ...
  const onCopy = async (userId) => {
    ...
    setCopy(true);
    setCopyId(userId);
    const inviteLink = `${window.location.protocol}//${window.location.host}/invite?inviteId=${userId}`;
                            ...
                            {viewOnly ? (
                              ...
                              <div className="flex gap-2 items-end">
                                ...
                                {selectedUser?.pictureUrl !== "" &&
                                  selectedUser?.pictureUrl !== undefined && (
                                    <Button
                                      variant="secondary"
                                      size="sm"
                                      onClick={(e) => {
                        ...
                        <td>
                          <div className="p-4 gap-4 flex items-center">
                            ...
                            {viewOnly ? (
                              ...
                              <select
                                defaultValue={selectedUser?.securityLevel || ""}
